...
type: doc
version: v2
tags: [asklens, v2, ingestion, etl, document, hybrid-search]
status: published
related:
  - "[[V2.0-设计决策]]"
  - "[[V1.0-项目文档]]"
...
└── AskLens-backend/
    ...
    └── src/main/
        ...
        └── java/com/asklens/
            ├── AskLensBackendApplication.java      # 启动类
...
storage:
  minio:
    ...
    bucket: ${MINIO_BUCKET:asklens-documents}
```
...
启动后访问 `http://192.168.200.130:9001` 进入 MinIO Console，创建名为 `asklens-documents` 的 Bucket。
