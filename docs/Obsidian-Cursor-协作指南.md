...
| 阶段 | Obsidian | Cursor |
|------|----------|--------|
| 学架构 | 读 [[AskLens-学习指南]]，Graph 看模块关系 | `@docs/...` 让 AI 对照源码讲解 |
...
Vault 是 `docs/`，Git 根是上一级 `AskLens/`，必须设置：
...
```
D:\Develop\AskLens\docs\.obsidian\plugins\obsidian-git\
```
